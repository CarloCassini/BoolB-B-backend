        ...
        <thead>
          ...
          <tbody>
            ...
            <tr>
                ...
                {{-- * image --}}
                <td>
                    <img src="@if($apartment->cover_image_path){{$apartment->cover_image_path}}@else{{'https://via.placeholder.com/200x150.png/333333?tex'}}@endif" class="img-fluid" alt="cover">
                </td>
                ...
                <td class="h-100">
                    <div class="h-100 d-flex align-items-center justify-content-between">
                        <a href="{{ route('admin.apartments.show', $apartment)}}"><i class="fa-solid fa-eye text-"></i></a>
                        <a href="{{ route('admin.apartments.edit', $apartment)}}"><i class="fa-solid fa-pencil text-warning"></i></a>
                        <a href="#"data-bs-toggle="modal" data-bs-target="#modal-{{$apartment->id}}"><i class="fa-solid fa-trash text-danger"></i></a>
                    </div>
                </td>
              </tr>
            @empty
